...
/**
 * Created by mraavi on 06/04/17.
 */

public class LivingBeingsAdapter extends BaseExpandableListAdapter {
    HashMap<String, ArrayList<String>> mLivingBeings;
    ArrayList<String> mLivingBeingGroups;
    Context mContext;

    public LivingBeingsAdapter(Context context, HashMap<String, ArrayList<String>> livingBeings, ArrayList<String> livingBeingGroups) {
